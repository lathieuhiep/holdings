 ...
 * @return void
 */
function holdings_remove_wp_jquery_core(WP_Scripts $scripts): void
{
...
add_action('wp_default_scripts', 'holdings_remove_wp_jquery_core');
 ...
 * @return void
 */
function holdings_remove_wp_block_css_core(): void
{
...
add_action('wp_enqueue_scripts', 'holdings_remove_wp_block_css_core', 100);
 ...
 * @return void
 */
function holdings_enqueue_theme_assets(): void
{
    // font icons style.
    ...
    wp_enqueue_style('holdings-main', get_theme_file_uri('/assets/css/main.css'), [], wp_get_theme()->get('Version'));

    // Enqueue 404 page-specific style.
    if (is_404()) {
        wp_enqueue_style('holdings-page-404', get_theme_file_uri('/assets/css/page-templates/page-404.min.css'), [], wp_get_theme()->get('Version'));
    }
    ...
    wp_enqueue_script('holdings-main', get_theme_file_uri('/assets/js/functions.js'), ['jquery'], wp_get_theme()->get('Version'), true);
}

add_action('wp_enqueue_scripts', 'holdings_enqueue_theme_assets');