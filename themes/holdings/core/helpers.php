 ...
 * @return T|null
 */
function holdings_get_opt(string $class)
{
 ...
 */
function holdings_pagination_custom( $args = array() ): void
{
    global $wp_query;
    ...
    $defaults = array(
        'type' => 'list',
        'mid_size' => 2,
        'prev_text' => esc_html__('Trước', 'holdings'),
        'next_text' => esc_html__('Sau', 'holdings'),
        'screen_reader_text' => '&nbsp;',
    );
 ...
 */
function holdings_pagination_query( $query, $args = array() ): void
{
...
// replace number
function holdings_preg_replace_ony_number( $string ): string|null {
    $number = '';
