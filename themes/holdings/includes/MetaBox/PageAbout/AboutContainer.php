...
final class AboutContainer
{
    ...
    protected static function register(): void
    {
        Container::make(
            'post_meta',
            esc_html__('About Page Options', 'holdings')
        )
            ...
            ->add_tab(
                ...
                esc_html__('Điểm nổi bật', 'holdings'),
                HighlightsTab::fields()
            )
            ->add_tab(
                esc_html__('Không gian sống', 'holdings'),
                LivingSpaceTab::fields()
            )
            ->add_tab(
                esc_html__('Đầu tư + vận hành.', 'holdings'),
                OperatorTab::fields()
            )
            ->add_tab(
                esc_html__('Dịch vụ bao gồm', 'holdings'),
