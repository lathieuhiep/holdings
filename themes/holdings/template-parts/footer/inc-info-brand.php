...
// Get copyright text
$show_copyright = holdings_get_opt(CopyrightOptions::class)?->get_show_copyright() ?? true;
$copyright_heading = holdings_get_opt(CopyrightOptions::class)?->get_content_heading() ?? '';
$copyright_text = holdings_get_opt(CopyrightOptions::class)?->get_content_copyright() ?? '';

// Get address columns
$address_columns = holdings_get_opt(FooterOptions::class)?->get_opt_footer_address_columns() ?? [];

// Get contact info
$phone = holdings_get_opt(ContactOptions::class)?->get_otp_contact_phone() ?? '091 3833 333';
$email = holdings_get_opt(ContactOptions::class)?->get_opt_contact_email() ?? 'thaihoangapartmenthd@gmail.com';
$social_links = holdings_get_opt(ContactOptions::class)?->get_opt_contact_social_links() ?? [];
?>
