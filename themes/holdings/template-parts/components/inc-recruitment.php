...
$recruitment_options = holdings_get_opt(RecruitmentOptions::class)?->get_opt_recruitment_images() ?? [];
...
<section class="section sec-homeCongViec" id="id-congviec">
    <div class="container">
        <h2 class="titlebox__title wow fadeInUp">
            <?php esc_html_e('Cơ Hội Nghề Nghiệp', 'holdings'); ?>
        </h2>
                ...
                <div class="col-md-6 offset-md-3 col-xl-4 offset-xl-4">
                    <div class="item-text">
                        <div class="f-entry wow fadeInUp">
                            <p>
                                <?php esc_html_e('Bạn đang tìm kiếm một môi trường làm việc chuyên nghiệp, năng động và đầy cơ hội phát triển? Thai Hoang Holdings chính là nơi dành cho bạn! Chúng tôi đang mở rộng quy mô và tìm kiếm những cá nhân tài năng, nhiệt huyết để cùng đồng hành và tạo nên những bước tiến mới! Để ứng tuyển, vui lòng liên hệ bộ phận HCNS tại:' , 'holdings'); ?>
                            </p>
                        </div>
