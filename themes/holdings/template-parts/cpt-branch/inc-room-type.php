...
$meta_rooms = holdings_get_opt(BranchMetaBox::class)?->get_post_meta_rooms(get_the_ID());
$meta_location = holdings_get_opt(BranchMetaBox::class)?->get_post_meta_location(get_the_ID());
...
<div class="item-content">
    <div class="tabbox" data-fix-wow="true">
        <div class="tabbox-fix wow fadeInUp">
            <p><?php esc_html_e('Loại Phòng', 'holdings'); ?></p>
                            ...
                            ?>
                                <div class="g-img g-img-more">
                                    <div class="g-img__inner wow fadeInUp">
                                        ...
                                        <span><?php esc_html_e( 'Xem thêm', 'holdings' ); ?></span>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
