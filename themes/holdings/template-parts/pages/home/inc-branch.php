...
$title = ! empty( $data['title'] ) ? $data['title'] : esc_html__( 'Các Chi Nhánh', 'holdings' );
                ...
                <div class="item-duan__head wow fadeInUp">
                    ...
                    <div>
                        <a href="<?php echo esc_url( $url ) ?>" class="f-btn">
                            <?php esc_html_e('giới thiệu chung', 'holdings'); ?>
                        </a>
                    </div>
                </div>
                        ...
                        <div class="swiper">
                            <div class="swiper-wrapper">
                                ...
                                foreach ($branch_ids as $index => $branch_id) :
                                    ...
                                    $branch_info = holdings_get_opt(BranchMetaBox::class)?->get_post_meta_more_info($branch_id);
                                        ...
                                        >
                                            ...
                                            <a href="<?php echo esc_url($link); ?>" class="chinhanhBox__body">
                                                ...
                                                <h3 class="chinhanhBox__title">
                                                    <span><?php esc_html_e('Thái Hoàng', 'holdings'); ?></span>
